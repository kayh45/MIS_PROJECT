...
<!-- 네비게이션 바 -->
	...
	<div class = "fmcontent">
	<h3>오늘의 한마디 작성</h3>
<form name = "fm" method=post action="<%=contextName%>/board.do?act=EMPC" onsubmit="return modify_click(this);">
	...
	제목: <input type = "text" class = "form-control" name = "boardSub"><br>
	내용: <input type = "text" class = "form-control" name = "boardCont"><br>
